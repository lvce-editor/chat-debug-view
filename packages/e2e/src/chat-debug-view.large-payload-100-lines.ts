...
export const test: Test = async ({ ChatDebug, expect, Locator }) => {
  ...
  const lineNumbersNth99 = lineNumbers.nth(99)
  await expect(lineNumbersNth99).toHaveText('100')
  ...
  const lineContentsNth99 = lineContents.nth(99)
  await expect(lineContentsNth99).toHaveText('line 100')
}

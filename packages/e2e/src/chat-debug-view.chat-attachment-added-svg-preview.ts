...
const svgMarkup = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><rect width="24" height="24" fill="#0b6"/><circle cx="12" cy="12" r="6" fill="#fff"/></svg>'

...
test('getReadFilePreviewText should return result.content for structured read_file events', () => {
  const result = GetReadFilePreviewText.getReadFilePreviewText(
    {
      arguments: {
        uri: 'file:///workspace/test.txt',
...
test('getReadFilePreviewText should return first result item content for structured array read_file events', () => {
  const result = GetReadFilePreviewText.getReadFilePreviewText(
    {
      arguments: {
        uri: 'file:///workspace/test.txt',
...
test('getReadFilePreviewText should return undefined when result does not contain content', () => {
  const result = GetReadFilePreviewText.getReadFilePreviewText(
    {
      eventId: 1,
      name: 'read_file',

...
test('getCss should style the table column resizers and expose their offsets', () => {
  ...
  expect(css).toContain('.ResizerFour {\n  left: var(--ResizerFourLeft);')
})
